...
public class BaseKnowledge {
   ...
   public OntModel ontology;
    ...
    public BaseKnowledge(String ontoPath){
        ...
        cache.put("Coinmarketcap".toLowerCase(),"System");
        ...
        cache.put("facebook".toLowerCase(),"System");
        cache.put("Twitter".toLowerCase(),"System");
        cache.put("Instagram".toLowerCase(),"System");
        cache.put("Reddit".toLowerCase(),"System");
